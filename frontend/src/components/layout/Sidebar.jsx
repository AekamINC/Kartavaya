...
const ICONS = {
  ...
  attendance:  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.4"><path d="M8 14s4.5-3.6 4.5-7A4.5 4.5 0 003.5 7c0 3.4 4.5 7 4.5 7z"/><circle cx="8" cy="6.8" r="1.7"/></svg>,
...
const NAV_FULL = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/attendance',  icon: 'attendance',  en: 'Attendance',  hi: 'उपस्थिति' },
